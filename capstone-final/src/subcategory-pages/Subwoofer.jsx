...
import SubwooferImage from '../assets/SubwooferImage.png'; // Replace with the path to your image
      ...
      <div className="relative w-full h-[700px] bg-no-repeat bg-center bg-cover">
        <div className="absolute inset-0">
          <div
            ...
            style={{ backgroundImage: `url(${SubwooferImage})`, opacity: 0.3, zIndex: -1 }}
          />
        </div>
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-10">
          <h1 className="text-4xl font-bold">Subwoofer</h1>
          <p className="mt-4 text-lg text-gray-400">
            Discover the best subwoofers for immersive sound experiences.
          </p>
        </div>
      </div>
