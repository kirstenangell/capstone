    ...
    <div className="min-h-screen bg-black text-white py-10">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button className="px-4 py-2 bg-gradient-to-r from-[#335C6E] to-[#000000] text-white rounded-lg text-sm">
            Add Order
          </button>
        </div>
  ...
  >
    ...
    <div className="mt-4 bg-gradient-to-r from-[#4B88A3] via-[#040405] to-[#4B88A3] p-4 rounded-lg">
      ...
      <div className="mt-2 h-2 bg-[#2D3748] rounded-full">
        <div className="h-full bg-[#62B1D4] rounded-full w-[50%]"></div> {/* Progress bar with dynamic width */}
      </div>
    </div>
  </div>
))}
