...
import Category from '../product-page-component/Category';
import FlackoLogo from '../assets/FlackoLogo.png';

const DummyNavbar = ({ cartItemCount, isLoggedIn, handleLogout }) => {
          ...
          <NavLink
            ...
            style={({ isActive }) =>
              isActive
                ? {
                    background:
                      'linear-gradient(45deg, #4B88A3 0%, #040405 0%, #4B88A3 180%)',
